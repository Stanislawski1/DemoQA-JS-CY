...
const accordianText = [
    {textOne: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ' +
     ...
     textTwo:'Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical' +
     ...
     textThree: 'It is a long established fact that a reader will be distracted by the readable' +
